...
The Sheet component is included in the `@kareyes/aether-ui` package.
...
```svelte
<script lang="ts">
  import { Sheet, SheetContent, SheetTrigger } from "@kareyes/aether-ui";
  import { Button } from "@kareyes/aether-ui";
...
<script lang="ts">
  ...
  import { Label } from "@kareyes/aether-ui";
