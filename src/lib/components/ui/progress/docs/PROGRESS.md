...
Displays a horizontal bar indicating how far along a task or metric is. Supports determinate values, indeterminate loading state, labels, and a rich set of visual variants.
